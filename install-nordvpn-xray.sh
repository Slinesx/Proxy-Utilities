...
# URLs for emoji mapping utilities
EMOJI_DATA_URL="https://raw.githubusercontent.com/Slinesx/Proxy-Utilities/main/emoji_data.sh"
EMOJI_UTILS_URL="https://raw.githubusercontent.com/Slinesx/Proxy-Utilities/main/emoji_utils.sh"
...
# 3) fetch emoji scripts
EMOJI_DATA_TMP="$(mktemp)"
EMOJI_UTILS_TMP="$(mktemp)"
curl -fsSL "$EMOJI_DATA_URL"  -o "$EMOJI_DATA_TMP"
curl -fsSL "$EMOJI_UTILS_URL" -o "$EMOJI_UTILS_TMP"
